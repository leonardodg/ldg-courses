...
$string['onboardingcontinue'] = 'Continuar cadastro';
$string['onboardingprogress'] = 'Ativacao da conta: {$a}% concluida';
...
$string['stepgateway'] = 'Conectar um meio de pagamento';
$string['stepplan'] = 'Escolher um plano';
