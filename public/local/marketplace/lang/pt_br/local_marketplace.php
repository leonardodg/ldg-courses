...
$string['bunnyaccountapikey'] = 'Chave de API da conta Bunny';
$string['bunnyaccountapikey_desc'] = 'A chave da conta Bunny Stream única da plataforma, usada só para criar uma library nova para cada empresa, na hora em que ela é criada. Não é a chave de nenhuma library: a chave própria de cada empresa fica guardada à parte, cifrada, assim que a library é provisionada. Deixe vazia para manter o provisionamento em espera — as empresas continuam nascendo normalmente, só sem library ainda.';
$string['buynow'] = 'Comprar agora';
$string['byosapikey'] = 'Chave de API da library';
$string['byosapikey_help'] = 'Stream → Library → API no seu painel da Bunny.net.';
$string['byoscdnhostname'] = 'Hostname da CDN (opcional)';
$string['byosconnect'] = 'Conectar';
$string['byosconnected'] = 'Conectada à sua library #{$a} da Bunny.';
$string['byosintro'] = 'Este plano hospeda vídeo na sua própria conta Bunny.net Stream — a plataforma nunca vê nem paga a sua banda. Crie uma library no seu painel da Bunny primeiro, depois cole os dados dela abaixo.';
$string['byoslibraryid'] = 'ID da library';
$string['byosnotconnected'] = 'Nenhuma library da Bunny conectada ainda — o envio de vídeo não vai funcionar até você conectar uma.';
$string['byosoverwritewarning'] = 'Esta empresa hoje hospeda vídeo na library da própria plataforma. Conectar a sua abaixo troca na hora: qualquer vídeo já publicado em curso para de tocar, sem migração automática.';
$string['byossection'] = 'Vídeo (sua própria conta Bunny)';
$string['byossecuritykey'] = 'Chave de autenticação por token (opcional)';
...
$string['errorbunnyapi'] = 'A API da Bunny devolveu um erro: {$a}';
$string['errorbunnylibraryidtaken'] = 'Esta library da Bunny já está conectada a outra empresa.';
...
$string['errorcoursenotowned'] = 'Este curso nao pertence a esta empresa.';
$string['errorcurl'] = 'Não foi possível falar com a API da Bunny: {$a}';
...
$string['errorinvalidresolution'] = '"{$a}" não é uma resolução que a plataforma reconhece.';
$string['errorinvalidresponse'] = 'A API da Bunny devolveu uma resposta que não foi possível entender.';
$string['errorlibrarytaken'] = 'Esta empresa já tem uma library na Bunny.';
...
$string['errornoencryptionkey'] = 'Esta instalação não tem chave de cifragem configurada, então a chave da Bunny não pode ser guardada.';
$string['errornotbyos'] = 'Esta empresa não está num plano de traga-sua-própria-conta de streaming. Troque o plano primeiro.';
