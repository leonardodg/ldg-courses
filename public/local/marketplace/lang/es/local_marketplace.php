...
$string['bunnyaccountapikey'] = 'Clave de API de la cuenta Bunny';
$string['bunnyaccountapikey_desc'] = 'La clave de la única cuenta de Bunny Stream de la plataforma, usada solo para crear una library nueva para cada empresa en el momento en que se crea. No es la clave de ninguna library: la clave propia de cada empresa se guarda aparte, cifrada, en cuanto la library queda provisionada. Dejala vacía para mantener el provisionamiento en espera — las empresas se siguen creando normalmente, solo que sin library todavía.';
$string['buynow'] = 'Comprar ahora';
$string['byosapikey'] = 'Clave de API de la library';
$string['byosapikey_help'] = 'Stream → Library → API en tu panel de Bunny.net.';
$string['byoscdnhostname'] = 'Hostname de la CDN (opcional)';
$string['byosconnect'] = 'Conectar';
$string['byosconnected'] = 'Conectada a tu library #{$a} de Bunny.';
...
$string['errorcurl'] = 'No se pudo contactar la API de Bunny: {$a}';
...
$string['errorinvalidresolution'] = '"{$a}" no es una resolución que la plataforma reconozca.';
$string['errorinvalidresponse'] = 'La API de Bunny devolvió una respuesta que no se pudo entender.';
$string['errorlibrarytaken'] = 'Esta empresa ya tiene una library en Bunny.';
...
$string['errornoencryptionkey'] = 'Esta instalación no tiene clave de cifrado configurada, así que la clave de Bunny no se puede guardar.';
$string['errornotbyos'] = 'Esta empresa no está en un plan de traé-tu-propia-cuenta de streaming. Cambiá el plan primero.';
