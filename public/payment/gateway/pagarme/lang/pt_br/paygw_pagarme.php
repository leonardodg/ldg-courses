...
$string['billingcity'] = 'Cidade';
$string['billingline1'] = 'Rua, número e bairro';
$string['billingstate'] = 'UF (duas letras)';
$string['billingzipcode'] = 'CEP';
...
$string['errorchargemissing'] = 'O Pagar.me confirmou o pedido mas não devolveu nenhuma cobrança para pagar.';
...
$string['errornophone'] = 'Seu perfil está sem telefone. Preencha antes de comprar — o Pagar.me exige.';
...
$string['linkdonenosplit'] = 'Conta vinculada, mas o Pagar.me ainda não tem recebedor padrão para ela - as cobranças não vão dividir comissão até o vendedor terminar o cadastro no Pagar.me e você vincular de novo.';
