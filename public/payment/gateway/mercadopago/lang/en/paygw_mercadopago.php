...
$string['cardcaptureaccount_help'] = 'Leave empty to use the site default below. Choosing a mode here overrides it only for this company.';
...
$string['cardcaptureusesite'] = 'Use the site default';
...
$string['methodboleto_desc'] = 'Site-wide default for whether the bank slip tab is offered. A company can override this on its own payment account.';
$string['methodcard'] = 'Accept card';
$string['methodcard_desc'] = 'Site-wide default for whether the card tab is offered. A company can override this on its own payment account.';
$string['methoddisabled'] = 'Disabled';
$string['methodenabled'] = 'Enabled';
$string['methodpix'] = 'Accept Pix';
$string['methodpix_desc'] = 'Site-wide default for whether the Pix tab is offered. A company can override this on its own payment account.';
$string['methodusesite'] = 'Use the site default';
