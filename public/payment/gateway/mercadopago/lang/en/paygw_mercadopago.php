...
$string['cardholderdoc'] = 'Cardholder ID number';
...
$string['publickey_desc'] = 'Shown in the Mercado Pago panel next to the access token. Needed only to build the card fields in the browser — it is public by design and appears in the page source.';
