...
$string['cardcapture_desc'] = 'The payment page is ours either way, with our own layout. What changes is who hosts the three card fields — and with it whether this project falls inside PCI DSS scope.';
$string['cardcapturebrick'] = 'Mercado Pago fields inside our page (recommended, no PCI scope)';
$string['cardcapturenative'] = 'Our own form, card number through our backend (PCI DSS SAQ D)';
$string['cardcapturenativeblocked'] = 'This site is not served over HTTPS, so the card number would travel in clear text. The setting below is being IGNORED and the Mercado Pago fields are in use. No configuration compensates for missing TLS.';
