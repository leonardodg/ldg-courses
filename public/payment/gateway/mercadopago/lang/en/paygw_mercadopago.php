...
$string['cardcaptureaccount'] = 'Where the card is typed (this company)';
$string['cardcaptureaccount_help'] = 'Leave empty to use the Mercado Pago gateway default below. Choosing a mode here overrides it only for this company.';
...
$string['cardcaptureusesite'] = 'Use the Mercado Pago default';
...
$string['errornopaymentmethod'] = 'This company has no payment method enabled for subscriptions. Enable at least one on its payment account.';
...
$string['methodaccountboleto'] = 'Bank slip (this company)';
$string['methodaccountcard'] = 'Card (this company)';
$string['methodaccountpix'] = 'Pix (this company)';
$string['methodboleto'] = 'Accept bank slip';
$string['methodboleto_desc'] = 'Mercado Pago gateway default for whether the bank slip tab is offered. A company can override this on its own payment account.';
$string['methodcard'] = 'Accept card';
$string['methodcard_desc'] = 'Mercado Pago gateway default for whether the card tab is offered. A company can override this on its own payment account.';
$string['methoddisabled'] = 'Disabled';
$string['methodenabled'] = 'Enabled';
$string['methodpix'] = 'Accept Pix';
$string['methodpix_desc'] = 'Mercado Pago gateway default for whether the Pix tab is offered. A company can override this on its own payment account.';
$string['methodusesite'] = 'Use the Mercado Pago default';
