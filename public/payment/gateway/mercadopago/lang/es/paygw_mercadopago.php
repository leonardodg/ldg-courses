...
$string['cardcaptureaccount'] = 'Donde se escribe la tarjeta (esta empresa)';
$string['cardcaptureaccount_help'] = 'Deje vacio para usar el valor por defecto de la pasarela Mercado Pago, abajo. Elegir un modo aqui vale solo para esta empresa.';
...
$string['cardcaptureusesite'] = 'Usar el valor por defecto de Mercado Pago';
...
$string['confirmcycleamount'] = 'Confirmá el cobro de {$a} de este ciclo.';
$string['confirmcyclecancel'] = 'Ahora no — volver a mis suscripciones';
$string['confirmcycleexplain'] = 'Esta cuenta no puede cobrar tu tarjeta automáticamente. Ingresá el código de seguridad para confirmar — va directo a Mercado Pago y nunca se guarda.';
$string['confirmcycletitle'] = 'Confirmar ciclo de la suscripción';
...
$string['errornopaymentmethod'] = 'Esta empresa no tiene ningun medio de pago habilitado para suscripcion. Habilite al menos uno en su cuenta de pago.';
...
$string['messageprovider:reminderupcoming'] = 'Renovación de suscripción próxima (Pix o boleto)';
$string['methodaccountboleto'] = 'Boleto (esta empresa)';
$string['methodaccountcard'] = 'Tarjeta (esta empresa)';
$string['methodaccountpix'] = 'Pix (esta empresa)';
$string['methodboleto'] = 'Aceptar boleto';
$string['methodboleto_desc'] = 'Valor por defecto de la pasarela Mercado Pago para ofrecer la pestana de boleto. Cada empresa puede sobrescribirlo en su propia cuenta de pago.';
$string['methodcard'] = 'Aceptar tarjeta';
$string['methodcard_desc'] = 'Valor por defecto de la pasarela Mercado Pago para ofrecer la pestana de tarjeta. Cada empresa puede sobrescribirlo en su propia cuenta de pago.';
$string['methoddisabled'] = 'Deshabilitado';
$string['methodenabled'] = 'Habilitado';
$string['methodpix'] = 'Aceptar Pix';
$string['methodpix_desc'] = 'Valor por defecto de la pasarela Mercado Pago para ofrecer la pestana de Pix. Cada empresa puede sobrescribirlo en su propia cuenta de pago.';
$string['methodusesite'] = 'Usar el valor por defecto de Mercado Pago';
...
$string['reminderdays'] = 'Días de anticipación para avisar de Pix/boleto';
$string['reminderdays_desc'] = 'La tarjeta se cobra sola, así que no necesita aviso. Pix y boleto sí: cada ciclo exige que el alumno actúe, y sin un aviso antes de que exista la factura, solo se entera cuando ya está por vencer.';
$string['reminderupcoming_body'] = 'Tu suscripción se renueva pronto, y el próximo cobro es de {$a}. Pix y boleto no se cobran solos: se emitirá uno nuevo cuando venza, y te avisamos de nuevo.';
$string['reminderupcoming_subject'] = 'Tu suscripción se renueva pronto';
...
$string['switchtocardcancel'] = 'Seguir pagando por Pix/boleto';
$string['switchtocarddone'] = 'Listo. Desde el próximo ciclo, esta suscripción cobra la tarjeta automáticamente.';
$string['switchtocardexplain'] = 'Esto no cobra nada ahora. La tarjeta queda guardada para los PRÓXIMOS ciclos — el actual, si ya se pagó por Pix o boleto, sigue como estaba.';
$string['taskchargeduecycles'] = 'Emitir ciclos vencidos de las suscripciones de Mercado Pago (pide confirmación del alumno)';
...
$string['taskremindupcomingcycles'] = 'Avisar de ciclos de suscripción por Pix/boleto próximos';
