...
$string['cardholderdoc'] = 'Documento del titular';
...
$string['publickey_desc'] = 'Se muestra en el panel de Mercado Pago junto al access token. Solo hace falta para construir los campos de la tarjeta en el navegador: es publica por naturaleza y aparece en el fuente de la pagina.';
