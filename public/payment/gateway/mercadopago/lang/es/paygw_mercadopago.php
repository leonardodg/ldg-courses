...
$string['cardcapture_desc'] = 'La pagina de pago es nuestra en ambos casos, con nuestro propio diseno. Lo que cambia es quien aloja los tres campos de la tarjeta, y con ello si este proyecto entra en alcance PCI DSS.';
$string['cardcapturebrick'] = 'Campos de Mercado Pago dentro de nuestra pagina (recomendado, sin alcance PCI)';
$string['cardcapturenative'] = 'Formulario propio, numero de tarjeta por nuestro backend (PCI DSS SAQ D)';
$string['cardcapturenativeblocked'] = 'Este sitio no se sirve por HTTPS, asi que el numero de tarjeta viajaria en texto claro. La opcion de abajo se esta IGNORANDO y se usan los campos de Mercado Pago. Ninguna configuracion compensa la falta de TLS.';
