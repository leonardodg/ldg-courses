...
$string['cardcaptureaccount_help'] = 'Deje vacio para usar el valor por defecto del sitio, abajo. Elegir un modo aqui vale solo para esta empresa.';
...
$string['cardcaptureusesite'] = 'Usar el valor por defecto del sitio';
...
$string['methodboleto_desc'] = 'Valor por defecto del sitio para ofrecer la pestana de boleto. Cada empresa puede sobrescribirlo en su propia cuenta de pago.';
$string['methodcard'] = 'Aceptar tarjeta';
$string['methodcard_desc'] = 'Valor por defecto del sitio para ofrecer la pestana de tarjeta. Cada empresa puede sobrescribirlo en su propia cuenta de pago.';
$string['methoddisabled'] = 'Deshabilitado';
$string['methodenabled'] = 'Habilitado';
$string['methodpix'] = 'Aceptar Pix';
$string['methodpix_desc'] = 'Valor por defecto del sitio para ofrecer la pestana de Pix. Cada empresa puede sobrescribirlo en su propia cuenta de pago.';
$string['methodusesite'] = 'Usar el valor por defecto del sitio';
