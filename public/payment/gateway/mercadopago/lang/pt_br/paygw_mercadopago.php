...
$string['cardcaptureaccount'] = 'Onde o cartão é digitado (desta empresa)';
$string['cardcaptureaccount_help'] = 'Deixe vazio para usar o padrão do gateway Mercado Pago, abaixo. Escolher um modo aqui vale só para esta empresa.';
...
$string['cardcaptureusesite'] = 'Usar o padrão do Mercado Pago';
...
$string['errornopaymentmethod'] = 'Esta empresa não tem meio de pagamento habilitado para assinatura. Habilite pelo menos um na conta de pagamento dela.';
...
$string['methodaccountboleto'] = 'Boleto (desta empresa)';
$string['methodaccountcard'] = 'Cartão (desta empresa)';
$string['methodaccountpix'] = 'Pix (desta empresa)';
$string['methodboleto'] = 'Aceitar boleto';
$string['methodboleto_desc'] = 'Padrão do gateway Mercado Pago para oferecer a aba de boleto. Cada empresa pode sobrescrever isso na própria conta de pagamento.';
$string['methodcard'] = 'Aceitar cartão';
$string['methodcard_desc'] = 'Padrão do gateway Mercado Pago para oferecer a aba de cartão. Cada empresa pode sobrescrever isso na própria conta de pagamento.';
$string['methoddisabled'] = 'Desabilitado';
$string['methodenabled'] = 'Habilitado';
$string['methodpix'] = 'Aceitar Pix';
$string['methodpix_desc'] = 'Padrão do gateway Mercado Pago para oferecer a aba de Pix. Cada empresa pode sobrescrever isso na própria conta de pagamento.';
$string['methodusesite'] = 'Usar o padrão do Mercado Pago';
