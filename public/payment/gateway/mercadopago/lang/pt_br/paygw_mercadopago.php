...
$string['cardcaptureaccount_help'] = 'Deixe vazio para usar o padrão do site, abaixo. Escolher um modo aqui vale só para esta empresa.';
...
$string['cardcaptureusesite'] = 'Usar o padrão do site';
...
$string['methodboleto_desc'] = 'Padrão do site para oferecer a aba de boleto. Cada empresa pode sobrescrever isso na própria conta de pagamento.';
$string['methodcard'] = 'Aceitar cartão';
$string['methodcard_desc'] = 'Padrão do site para oferecer a aba de cartão. Cada empresa pode sobrescrever isso na própria conta de pagamento.';
$string['methoddisabled'] = 'Desabilitado';
$string['methodenabled'] = 'Habilitado';
$string['methodpix'] = 'Aceitar Pix';
$string['methodpix_desc'] = 'Padrão do site para oferecer a aba de Pix. Cada empresa pode sobrescrever isso na própria conta de pagamento.';
$string['methodusesite'] = 'Usar o padrão do site';
