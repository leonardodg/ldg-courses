...
$string['publickey_desc'] = 'Mostrada no painel do Mercado Pago ao lado do access token. Só é necessária para montar os campos do cartão no navegador — ela é pública por natureza e aparece no fonte da página.';
