...
$string['cardcapture_desc'] = 'A página de pagamento é nossa nos dois casos, com o nosso layout. O que muda é quem hospeda os três campos do cartão — e com isso se este projeto entra em escopo PCI DSS.';
$string['cardcapturebrick'] = 'Campos do Mercado Pago dentro da nossa página (recomendado, sem escopo PCI)';
$string['cardcapturenative'] = 'Formulário nosso, número do cartão pelo nosso backend (PCI DSS SAQ D)';
$string['cardcapturenativeblocked'] = 'Este site não é servido por HTTPS, então o número do cartão viajaria em texto claro. A opção abaixo está sendo IGNORADA e os campos do Mercado Pago estão em uso. Não há configuração que compense a falta de TLS.';
