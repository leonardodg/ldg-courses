...
# --- caixas --------------------------------------------------------------
for t in (plan_svg, tier_svg, comp_svg, memb_svg, acct_svg):
    p.append(t)
...
write_doc(
    ...
    'Esquema fisico das cinco tabelas que definem uma empresa vendedora no '
    'marketplace, o plano que ela contrata, as faixas de resolucao do plano, a '
    'conta de pagamento por pais e os vendedores ligados a ela.',
