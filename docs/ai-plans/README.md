...
| 2026-09-23 | [CS com `moodle-extra` e hub de produto](2026-09-23-cs-moodle-extra-e-hub-produto.md) | `inacabado` | **Etapa 0 com CI verde no PR #124** (phpcs 0 issues / 740 testes; `.phpcs.xml` + 134 `public const` + CI `moodle-extra` + doc de CS); **falta a revisão do usuário na doc de CS**. Etapa 1 (`docs/produto/`, 6 docs) **não começou** |
