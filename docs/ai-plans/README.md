...
| 2026-09-17 | [Assinatura SaaS: planos Start e PRO](2026-09-17-assinatura-saas-planos-start-e-pro.md) | `pendente` | desenho comercial (2 planos, comissão e mensalidade por tier) e esqueleto de arquitetura (`paymentarea 'plan'`, conta da plataforma, ledger próprio) — nenhum código ainda; faltam decisões de negócio e a identidade técnica da conta "plataforma" |
