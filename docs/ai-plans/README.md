...
| 2026-09-17 | [Assinatura SaaS: planos Start e PRO](2026-09-17-assinatura-saas-planos-start-e-pro.md) | `inacabado` | desenho comercial (2 planos, comissão e mensalidade por tier) e esqueleto de arquitetura (`paymentarea 'plan'`, conta da plataforma) — decisões todas fechadas e implementadas (ver plano de implementação), falta só a prova com dinheiro real |
| 2026-09-17 | [Assinatura SaaS: implementação dos planos Start e PRO](2026-09-17-implementacao-assinatura-saas-planos-start-pro.md) | `inacabado` | Fases A–E: planos/conta da plataforma, `paymentarea 'plan'` no `service_provider`, `$paymentarea` nas três funções genéricas do `api.php`, os três gateways, botão de pagar em `company.php` — 162 testes verdes, worktree `saas-planos-start-pro`; falta a prova com dinheiro real |
