...
| 2026-09-23 | [CS com `moodle-extra` e hub de produto](2026-09-23-cs-moodle-extra-e-hub-produto.md) | `inacabado` | **Etapa 0 local verde** (phpcs 0 issues / 740 testes; `.phpcs.xml` + 134 `public const` + CI `moodle-extra` + doc de CS); **falta commit/PR/checkpoint**. Etapa 1 (`docs/produto/`, 6 docs) **não começou** |
