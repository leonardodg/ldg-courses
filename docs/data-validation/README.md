...
| [`assinatura-saas-plano-empresa.md`](assinatura-saas-plano-empresa.md) | provar a **assinatura SaaS**: a empresa parceira pagando a plataforma (não o contrário) — conta da plataforma, login do gerente, o que conferir no banco |
